...
public WebDriver driver;
	...
	public void onStart(ITestContext context) {
		...
		try {
			extentReport = com.tutorialsninja_Testdata.ExtentReporter.generateExtentReport();
		} catch (Exception e) {
	...
	public void onFinish(ITestContext context) {
	    ...
	    String pathOfExtentReport = System.getProperty("user.dir")+ "\\test-output\\ExtentReportsExtentReports\\extentreport.html";
